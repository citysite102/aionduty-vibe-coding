...
const LIVE_TITLES = [
  ...
  "四個沒講清楚就會被它自己決定的地方",
  "讓計時器使用 API 取得資料",
  "叫它寫一個批次改檔名的 Node.js 腳本",
  "爬蟲：讓腳本自己開瀏覽器，抓成一張表",
  "Claude Code 做得好與做不好的事",
  "該用對話框還是 Claude Code？五個情境",
  "你手上現在有的三樣東西",
  "選修：終端機與 Claude Code 安裝",
  "選修：終端機基本指令",
  "選修：Warp 終端機的三個特點",
  "Claude Code 終端機版本配置",
  "選修：模式切換、Shell 模式、終止執行",
  "Agent 運作框架與 CLAUDE.md",
  "每次開新對話，你都要重講一次規則",
  "什麼是運作框架（Harness）？",
  "完整的運作框架有哪些零件",
  "Harness 對成本的影響",
  ...
  "Claude Code 的六個權限模式",
  "動手搭建運作框架",
  "補四條規則進 CLAUDE.md，再試它一次",
  "用 /context 確認 CLAUDE.md 真的載入了",
  "常見的三種錯誤規則寫法",
  "CLAUDE.md 的作用、長度與分層",
  "根目錄的手冊整場都在，Rules 碰到才載",
