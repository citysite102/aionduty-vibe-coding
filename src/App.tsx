...
const LIVE_TITLES = [
  ...
  "動手前的前置作業",
  "四個階段，從看懂走到自己做出來",
  "學完帶走的三樣：上線的作品、專案手冊、審查角色",
  "Vibe Coding 與 Agentic Engineering",
  "什麼是 Vibe Coding？",
  "三個詞的定位：Vibe Coding、Agentic Engineering 與 Agent",
  "三種開發模式的比較：需求細度與驗收方式",
  "照你的目標，挑一種 AI 工具",
  "同一個需求的三種做法：單次、重複、系統化",
  ...
  "一次請求的完整流程：前端、後端與資料庫",
  "前端與後端各自負責什麼",
  "同一批資料：全塞一張表，或拆表用 id 串起來",
  "從本機到上線：交給託管平台",
  "Git 幫你記下每一版，不只是程式碼",
  "按按看，檔案怎麼從資料夾走到 GitHub",
  "Claude Code 桌面版的畫面：只有底下的輸入框要你動",
  "Claude Code 的三個按鍵：檔案補全、退回上一步、貼圖",
  "Claude Code 指令的四種類型",
  "探索、計畫、執行、驗證：Agent 做執行，驗證歸你",
  "做出你的第一個作品",
  "換你寫一次",
  "讓計時器去外面拿一筆資料",
  "叫它寫個小工具，幫你做雜事",
  "哪些事它做得好，哪些你得自己來",
  "該用什麼工具？",
  "這一章做完，你手上該有 mission-timer 與一個會動的計時器",
  "選修：終端機與 Claude Code 安裝",
  "選修：終端機基本指令互動練習",
  "選修：Warp 終端機的三個特點",
  "裝好終端機版，確認它讀得到你的專案",
  "選修：終端機的三種按鍵：模式切換、直通指令、喊停",
  "Agent 運作框架與成本分析",
  "每次開新對話，你都要重講一次規矩",
  "什麼是運作框架（Harness）？",
  "完整的運作框架有哪些零件",
  ...
  "這三種寫法，寫了等於沒寫",
  "CLAUDE.md 的作用、長度與分層",
  "一直在的 CLAUDE.md，碰到那一區才載的 Rules",
  "Skill、Subagent、MCP：叫到才進來",
  "光寫在手冊裡，擋不住",
  "手冊、Rules、Skill、Hook：誰叫它、什麼時候進來",
  ...
  "設一道會退回的品質防線",
  "動手做一個審查子代理",
  "用講師、學生、觀察員跑一次，找出自己看不到的洞",
  "把分工放進一個中型專案",
  "先把需求說成一頁",
  "先畫出產品由哪幾層組成",
  "資料庫先只講四張表",
  "報價系統的規範寫在哪：docs 文件、設計準則、CLAUDE.md",
  "用五個指令推進",
  "中型專案最常卡在這五件事",
  "三項成果：一個審查子代理、一次實測、一個判準",
  "Agent 循環開發流程與實戰案例",
  "與其自己一直下提示，不如讓它自己跑",
  "交代一輪工作的五個步驟",
  "它原地打轉的時候，你有四個動作可以做",
  "不用讀程式碼的三種把關：Lint、型別、開瀏覽器點一次",
  "紅字在跟你說三件事",
  "放手之前，先設好四道邊界",
  "讓計時器自己跑完一輪",
