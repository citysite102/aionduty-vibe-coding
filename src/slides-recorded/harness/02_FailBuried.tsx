...
export const meta: RecordedMeta = {
  ...
  title: '規則沒生效：被埋在後面',
  script:
    '第二種情況不一樣，而且它更讓人困惑：規則確實載入了，它就在對話裡，但檔案太長。一份三百行、六十條規則的手冊，排在最後面那幾條被遵守的機率，明顯低於排在最前面的。越長的內容，每一條分到的注意力越少。一般建議一份控制在兩百行以內，原因就在這裡。判斷方式很簡單：如果你的手冊已經很長，而且沒照做的都是後面那幾條，多半就是這個問題。',
  seconds: 44,
  from: 68,
};
