...
const CASES = [
  {
    tag: '無法判定',
    title: '規則沒生效：沒辦法檢查',
    desc: '「程式碼要優雅」沒有客觀判斷標準，它無法確認自己有沒有做到。',
  },
  {
    tag: '互相矛盾',
    title: '兩條規則同時滿足不了',
...
export const meta: RecordedMeta = {
  ...
  title: '為什麼規則沒有生效？',
  script:
    '第三種最麻煩，因為它最難查：規則載入了、位置也對，但它還是做不到。常見的有三個樣子。第一種，規則沒有可以檢查的標準，像是程式碼要優雅，沒有客觀判斷標準，它無法確認自己有沒有做到。第二種，兩條規則同時滿足不了。例如：一頁最多兩種強調色，跟錯誤用紅、正解用綠、警告用琥珀，這兩條放在一起，只要遇到三種情境就一定違反其中一條。第三種是你自己造成的，你在對話裡說過相反的話，那句話比手冊晚出現，它會照最近的指令走。',
  seconds: 45,
  from: 68,
};
