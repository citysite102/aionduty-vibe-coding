...
export const meta: RecordedMeta = {
  ...
  title: '那要怎麼知道是哪一種？',
  script:
    '三種原因的處理方式完全不同，所以不要一發現它沒照做就急著再加一條規則，那只會讓檔案更肥。我給你一張診斷路線，只有兩個問題。第一個：那份手冊在載入清單裡嗎？跑斜線 context 就知道。不在，就是位置問題，查到這裡結束。在的話往下問第二個：剛才那個決定依據哪一條？答不出來，代表句子寫壞了，要改寫成可以檢查的。答得出來卻還是做錯，多半是被埋在後面，或者兩條規則互相打架。位置最好處理，所以下一步先決定位置。',
  seconds: 45,
  from: 68,
};
