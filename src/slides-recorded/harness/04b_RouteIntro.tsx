...
/**
 * 歸位那四題原本是直接從第一題開始，方法本身寫成第一題頁面上的一行引言。
...
export const meta: RecordedMeta = {
  ...
  script:
    '剛才那三種原因裡，如果你查出來是「位置不對」，接下來就是這一題：這條規則到底該放哪。畫面上這四題，你照順序問過去，第一個答「是」的就是它該去的地方，後面不用再問。第一題，違反了會出事，絕對不能發生嗎？第二題，只在某一區檔案才適用嗎？第三題，有固定步驟，用到才需要嗎？第四題，以上皆非，而且每一輪都要記得嗎？順序千萬不要自己換，它是照「擋得住的程度」排的：先問擋得住的，再看範圍大小，最後才輪到那份每一輪都會載入的手冊。',
  seconds: 45,
};
