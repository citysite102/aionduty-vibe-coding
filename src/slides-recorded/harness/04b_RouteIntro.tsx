...
export const meta: RecordedMeta = {
  ...
  script:
    '診斷完是位置問題，接下來就是決定位置。前面零件總表提過的那三題，在這裡展開成四題，而且順序倒過來。照順序問，第一個答「是」的就是它該去的地方，後面不用再問。四題是這樣：違反了會出事，絕對不能發生嗎？只在某一區檔案才適用嗎？有固定步驟，用到才需要嗎？以上皆非，而且每一輪都要記得嗎？順序千萬不要自己換，因為它是照「擋得住的程度」排的：先問擋得住的，再看範圍大小，最後才是那份每一輪都會載入的手冊。',
  seconds: 42,
};
