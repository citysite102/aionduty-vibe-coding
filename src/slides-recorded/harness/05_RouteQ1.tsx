...
export const meta: RecordedMeta = {
  ...
  script:
    '第一個問題：違反了會出事，絕對不能發生嗎？如果是，交給 Hook 或 CI，就是前面看過的那兩道關卡。這一層跟另外三層有一個本質差別：它們都不在對話裡，是程式在擋，不經過 AI 判斷，所以它忘不掉，也繞不過。擋得住多少，看你的範圍圈了哪些工具。Hook 擋你這台機器，CI 擋整個團隊。像是不能把密碼或金鑰寫進程式碼裡，這種就屬於這一層。判準就是那一句：這件事錯一次，收得回來嗎。',
  seconds: 42,
  from: 69,
};
