    ...
    <SlideLayout title={meta.title} subtitle="Routing Your Rules" icon={ListChecks}>
      <div className="max-w-4xl mx-auto pt-2">
        ...
        <AnimatedBlock stepIndex={1} className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
          <div className="text-slate-500 text-base font-mono mb-3">依序要問的第 3 題，共 4 題</div>

          <div className="border-l-2 border-slate-700 pl-5 mb-7">
            <p className="text-slate-300 text-2xl leading-snug">有固定步驟，用到才需要？</p>
          </div>

          <p className="text-slate-100 text-4xl font-bold mb-5 leading-snug">寫成一個 Skill</p>
