...
export const meta: RecordedMeta = {
  ...
  title: '保證越高的，改起來越麻煩',
  script:
    '這四個去處有一個共同的取捨：擋得越死的，改起來越麻煩。Hook 是程式在擋，一定會執行，但你要去動設定檔；如果是 CI，還要開一次 PR 讓整個團隊一起改。反過來，寫在 CLAUDE.md 裡的規則就是一行文字，隨時能改，代價是它不保證會被照做。所以不要一律往最硬的那層塞，看那條規矩值不值得付那個改動成本。還有第二個原則：同一條規則不要放兩個地方。已經有 Hook 在擋的事，文字版就是重複的，那是你之後健檢時最容易刪掉的一批。',
  seconds: 38,
  from: 69,
};
