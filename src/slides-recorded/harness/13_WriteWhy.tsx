...
export const meta: RecordedMeta = {
  ...
  title: '規則要怎麼寫？',
  script:
    '第三個技巧：寫下理由，不要只寫規則。規則永遠寫不完，一定會有你沒想到的情況。如果你只寫按鈕文案要用航太語彙，然後列出發射、待機、返航，那出現第四個按鈕的時候它就不知道該叫什麼了。但如果你加一句因為這是太空任務主題的計時器，它就有依據可以自己延伸。理由的價值不在當下那條規則，在你沒寫到的那些情況。',
  seconds: 42,
  from: 70,
};
  ...
  return (
    <SlideLayout title={meta.title} subtitle="How to Phrase It" icon={Lightbulb}>
      <div className="max-w-4xl mx-auto pt-2 space-y-6">
        ...
        <DontDo
          stepFrom={2}
          bad="「按鈕文案使用航太語彙：發射、待機、返航。」"
          badNote="出現第四個按鈕時，它不知道該叫什麼。"
