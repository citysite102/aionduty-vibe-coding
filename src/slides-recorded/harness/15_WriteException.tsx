...
export const meta: RecordedMeta = {
  ...
  title: '規則怎麼寫：寫清楚例外',
  script:
    '第五個技巧：寫出例外。規則寫得越絕對，它套得越死。你寫禁止使用常駐的無限動畫，它可能連該有的載入指示也一起拿掉，然後你要回頭一條一條解釋。正確的寫法是把例外一起寫進去：禁止常駐的無限動畫，例外是真的要表達系統正在運轉的時候，全頁最多留一組，而且必須慢速、低對比。把例外一起寫進去，它才知道哪些情況不算違規。',
  seconds: 42,
  from: 70,
};
