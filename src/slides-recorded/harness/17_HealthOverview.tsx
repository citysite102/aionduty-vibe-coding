...
export const meta: RecordedMeta = {
  ...
  title: '手冊健檢：五步，順序不能換',
  script:
    'Hello，我是 Samuel，歡迎來到這個單元。手冊越寫越長是正常的，不是你沒紀律，因為每加一條的當下都有理由。所以它需要的不是克制，是一套固定的整理流程，建議每三個月跑一次。五步：盤點、減法、分流、加法、修剪。順序不能換，減法一定要排在分流前面，理由下一段會講。下面這段可以直接貼給它，注意最後那句要它先不要動檔案。',
  seconds: 42,
  from: 69,
};
