...
export const meta: RecordedMeta = {
  ...
  title: '同一句話，有沒有手冊差在哪',
  script:
    'Hello，我是 Samuel，歡迎來到這個單元。光講沒有體感，所以把前面那次驗收攤開來，兩邊對照著看。同一句話「幫我加一個 5 分鐘的休息模式」，兩次都沒有提任何規矩。左邊是手冊還沒寫的時候：按鈕寫成開始休息，不是那套航太語彙；順手塞了一張外部圖片當背景；分鐘數又寫死在程式碼裡，三條全沒中。右邊是同一個專案，只多了一份 CLAUDE.md：按鈕自己叫補給，沒有引用外部圖片，分鐘數也加在最上面的設定區。三條全中。',
  seconds: 44,
  from: 55,
};
