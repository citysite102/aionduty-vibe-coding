...
export const meta: RecordedMeta = {
  ...
  title: '規則該存在哪：這次對話，還是這個專案',
  script:
    '兩邊的差別不在它變聰明了，那是同一個模型。差別是那三條規則現在有一份固定的檔案，而那份檔案每次開新對話都會被自動讀進去。這就是 CLAUDE.md 在做的事，把你的要求從這次對話搬到這個專案。沒有手冊的時候，規則只存在這次對話裡，對話關掉就沒了，下一輪要從頭再講一次。寫進 CLAUDE.md 之後，不管你開幾次、誰來開，載入的都是同一份，你不必再重新交代那三條。',
  seconds: 38,
  from: 55,
};
