...
export const meta: RecordedMeta = {
  ...
  title: '一份不夠用的時候，還能放哪',
  script:
    '一份放在專案根目錄的手冊可以用很久，多數人一直到專案變大都不需要動它。真的要分，位置有四個。全域放在家目錄的 .claude 底下，放你跨所有專案的個人偏好，換到哪個專案都帶著。專案根目錄是整堂課的主力，前面你寫的那一份就是它，會進版本控制，團隊共用一份。子目錄那份平常不佔空間，只有動到那一區才讀進來。最後是 CLAUDE.local.md，放進 gitignore 不進版控，寫只有你這台機器成立的事。四個位置的原則只有一句：越靠近現場的越具體，也越優先。',
  seconds: 45,
  from: 58,
};
