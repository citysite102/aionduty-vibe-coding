...
export const meta: RecordedMeta = {
  ...
  title: '一份手冊該寫多長？',
  script:
    '一份大約控制在 200 行以內。這不是硬性規定，是實務上的觀察：越長，被遵守的比例越低，因為規矩越多，每一條分到的份量就越少。所以手冊變長的時候，正確的動作不是接著往下加，是回頭整理，這也是後面「手冊越寫越長怎麼整理」那一段要處理的事。另外，第一版不必自己從零寫，在專案裡輸入斜線 init，它會讀過你的專案再生一份草稿，你在上面改就好。',
  seconds: 44,
  from: 55,
};
