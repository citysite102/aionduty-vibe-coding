...
export const meta: RecordedMeta = {
  ...
  title: '一份手冊該寫多長？',
  script:
    '一份大約控制在 200 行以內。這不是硬規定，是實務上的觀察：越長，被遵守的比例越低，因為規矩越多，每一條分到的份量就越少。所以手冊變長的時候，動作不是接著往下加，是回頭整理。那要砍哪些？先砍三類。第一類，它讀程式碼就查得到的，像是用了哪些套件、檔案放在哪。第二類，只在某一區成立的，搬到剛才講的子目錄那一層，動到那一區才載入。第三類，寫了也驗不出來的，例如回覆要專業一點，那種留著只佔位置。另外第一版不必從零寫，輸入斜線 init，它會讀過你的專案生一份草稿。但它只寫得出現況，不是規矩，所以拿到草稿第一件事是改，不是存。',
  seconds: 56,
  from: 55,
};
