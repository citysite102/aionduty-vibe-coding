...
export const meta: RecordedMeta = {
  ...
  title: '三個地方，差別只有兩件事',
  script:
    'Hello，我是 Samuel，歡迎來到這個單元。CLAUDE.md 是 Claude Code 在讀的檔案，但你不會每天都開它，有時候只是想在網頁上問一句話。換到別的地方，前面學的要重學嗎？不用，這一點可以放心。手冊怎麼寫、分層怎麼分、規則該放哪，三個地方都成立。會變的只有兩件事：它碰得到哪些檔案，以及它能不能自己動手。網頁版只看得到你上傳的檔案，桌面版的 Cowork 綁一個資料夾、能讀能寫但不執行指令，Claude Code 整個專案都能讀，也能跑測試跟版本控制。',
  seconds: 44,
  from: 72,
};
