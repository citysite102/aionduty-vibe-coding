...
export const meta: RecordedMeta = {
  ...
  title: '三個地方，差別只有兩件事',
  script:
    '這一段從頭到尾都在講 CLAUDE.md，而它是終端機的東西。問題是你不會每天都開終端機，有時候只是想在網頁上問一句話。換到另外兩個地方，前面學的要重學嗎？不用。手冊怎麼寫、分層怎麼分、規則該放哪，三個地方都成立。會變的只有兩件事：它碰得到哪些檔案，以及它能不能自己動手。網頁版的 Projects 只看得到你上傳的檔案，不會動你的電腦。桌面版的 Cowork 綁一個資料夾，能讀能寫但不執行指令。Claude Code 整個專案都能讀，也能執行測試和版本控制，這堂課主要在用的就是它。差別都落在權限，不在你要怎麼寫手冊。',
  seconds: 44,
  from: 72,
};
