...
export const meta: RecordedMeta = {
  ...
  title: '為什麼不直接開新對話就好？',
  script:
    '有人會問，我每次開新對話把規矩貼一次不就好了，何必弄一個 Project。差別在兩件事。第一，你會漏。貼了三次之後就會少貼一條，而且是哪一條漏了你不會察覺。第二，貼在對話裡的東西會被稀釋，對話一長，前面交代的設定會被後面的內容蓋過去。放在指令欄的規矩不一樣，它每一輪都在，不會被推走。這跟終端機那邊根目錄的 CLAUDE.md 每一輪都載入，是同一個機制。',
  seconds: 42,
  from: 72,
};
