...
export const meta: RecordedMeta = {
  ...
  title: '換成你的工作，手冊該寫什麼',
  script:
    '換一個完全不是程式的工作。你負責寫客戶提案，這個月寫了五份，每一份都要重新交代提案分哪幾段、公司簡介用哪一版、語氣要多正式。A 客戶要英文版，B 客戶不收 PDF。而 D 客戶那一份，你差點把成本結構貼進要寄出去的檔案裡。這件事跟程式無關，但三個條件全中：重複發生、有你自己的規矩、每次都要重講。如果要交給 Claude 做，你的手冊會寫什麼？三格各一條，先自己想三十秒。',
  seconds: 40,
  from: 75,
};
