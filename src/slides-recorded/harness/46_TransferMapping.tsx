...
export const meta: RecordedMeta = {
  ...
  title: '提案那三條，各自該放哪一層',
  script:
    '第一題那一條不該只寫在手冊裡，成本外洩的代價太高，光靠文字擋不住，要加一道 Hook，在檔案要寄出去之前擋下來。第二題那一條，各客戶的專屬格式分到子目錄，用到那個客戶的時候才讀，這份手冊才不會越長越肥。第三題答出來那三條，是你每次都要重講的格式，留在根目錄那份就好。所以三個問題問完，內容有了，每一條該用什麼方式擋也一起決定了。',
  seconds: 42,
  from: 75,
};
