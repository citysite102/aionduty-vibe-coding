 ...
 */
const MAP = [
  { line: '第 1 題', q: '那一條', to: 'Hook', why: '外洩代價太高，文字擋不住', hard: true },
  { line: '第 2 題', q: '那一條', to: '子目錄', why: '只跟某個客戶有關', hard: false },
  { line: '第 3 題', q: '那三條', to: '根目錄手冊', why: '不會出事、也不只限某一區，才留在根目錄', hard: false },
];

export const meta: RecordedMeta = {
  id: 'harness-46-transfer-mapping',
  title: '提案的三條規則，各自該放哪一層',
  script:
    ...
    <SlideLayout title={meta.title} subtitle="Transfer It" icon={GitFork}>
      <RecPage className="space-y-5">
        ...
        <AnimatedBlock stepIndex={2} className="px-1">
          ...
          <span className="block mt-3 text-slate-500 text-lg">Skill 那一層這個例子還用不到。等你連提案的產製步驟都固定了，第三題那三條就會變成一個 Skill。</span>
          </p>
        </AnimatedBlock>
      </RecPage>
    </SlideLayout>
