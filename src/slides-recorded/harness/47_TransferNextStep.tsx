...
export const meta: RecordedMeta = {
  ...
  title: '換成你自己的工作，怎麼開始',
  script:
    '這三個問題跟你用哪個工具無關，換成別的 AI、換成完全不同的工作，要問的還是這三題。換成你自己的工作，就從這裡開始：挑一件你這個月重複做過三次以上的事，照三個問題各寫一句，先不要求完整。下次再做同一件事的時候把它貼上去，缺什麼再補。第一份三行就可以上場，不用等它寫完整。至於什麼時候該加 Skill、什麼時候該加 Hook，等你真的被同一件事絆到第二次再說，那時候你自然會知道它屬於哪一種。',
  seconds: 42,
  from: 75,
};
