...
export const meta: RecordedMeta = {
  ...
  title: '你完成了哪四件事',
  script:
    '入口那張地圖列了四個問題，現在四個都有答案了。它沒照做的時候，你知道先查哪裡，而不是急著再加一條。拿到一條規則，你知道該送去哪。手冊變肥的時候，你有五步可以整理，而且記得先刪再搬。每一條該怎麼寫，你有六個寫法，還有一句判準：另一個人只看結果，能不能回答有做到或沒做到。這四件事都收在同一個地方，你的專案資料夾裡多了一個 CLAUDE.md，它跟著專案走。但手冊管得到怎麼做，管不到誰來檢查，那是下一段的事。',
  seconds: 45,
  from: 76,
};
      ...
      <RecPage className="space-y-5">
        ...
        <AnimatedBlock stepIndex={3} className="px-1">
          <p className="text-slate-400 text-xl leading-relaxed">
            手冊管得到「怎麼做」，管不到「誰來檢查」。接下來要多找幾個角色進來互相檢查。
          </p>
        </AnimatedBlock>
      </RecPage>
    </SlideLayout>
