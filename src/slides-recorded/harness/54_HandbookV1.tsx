...
export const meta: RecordedMeta = {
  ...
  title: '你的手冊現在長這樣',
  script:
    '這就是你前面動手寫出來的那份手冊，放在專案根目錄。我把它整理成一個固定的樣子，後面每改一次都會回到同一個畫面，你才比得出改了什麼。這一版十四行，分成專案說明、畫面、程式、不要做四個區塊。先說在前面：這十四行裡面混著四種東西，該留的、該搬到別層去的、該刪掉的，還有一條寫了等於沒寫的。哪一條是哪一種，後面會一條一條拆。',
  seconds: 32,
  from: 58,
};
