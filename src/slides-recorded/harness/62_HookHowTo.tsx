...
export const meta: RecordedMeta = {
  ...
  script:
    'Hello，我是 Samuel，歡迎來到這個單元。分流的第一個去處就是 Hook，它到底是什麼？手冊是請它記得，而它可能沒讀到，也可能讀到了還是漏掉。Hook 完全不一樣，你寫一段設定，擋的動作是工具自己做的。你交代一件事，它動手之前先停下來，把要做的事交給你的設定檢查一次，說可以才過得去。被擋的時候它會看到理由，自己換寫法。這份簡報就掛著一條：寫檔案之前先看有沒有破折號。什麼時候值得掛？違反了會出事的，還有每一次都要做的。',
  seconds: 45,
  from: 68,
};
