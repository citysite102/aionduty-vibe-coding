...
export const meta: RecordedMeta = {
  ...
  script:
    '剛剛那三種原因，都是它讀了卻沒做到。那如果有一條規矩絕對不能違反呢？寫在手冊裡就不夠，因為手冊是請它記得，而它可能沒讀到，也可能讀到了還是漏掉。Hook 不一樣，你寫一段設定，擋的動作是工具自己做的，不經過它判斷。順序是你交代一件事，它動手之前會先停下來，把接下來要做的事交給你的設定檢查一次，說可以才過得去，說不行就擋下來。被擋的時候它會看到理由，然後自己換寫法重來，不需要你在場。這份簡報就掛著一條，每次要寫檔案之前先看有沒有破折號。什麼時候值得掛？違反了會出事的，還有每一次都要做的那種。',
  seconds: 45,
  from: 68,
};
