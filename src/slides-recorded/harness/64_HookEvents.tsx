 ...
 *
 * used 標的是最常掛的那兩個。學員需要知道哪幾個是真的會用到的，
...
export const meta: RecordedMeta = {
  ...
  script:
    '第一層是時機。官方支援三十幾種，你不用背，按階段各記一個就夠開始。接到指令的時候是 SessionStart，開新對話或接續舊紀錄會觸發，適合每次都要先講一遍的事。工具執行前是 PreToolUse，它準備動手但還沒動，這是唯一擋得住的時機，前面那條破折號就掛在這裡。工具跑完之後是 PostToolUse，東西已經寫進去了，適合自動排版這種補動作。收尾是 Stop，它覺得做完了、準備停下來，適合在這裡驗一次，沒過就叫它回去改。這四個裡面最常掛的是 PreToolUse 跟 Stop。想找其他的直接問它有哪些時機，不要背。',
  seconds: 45,
};
