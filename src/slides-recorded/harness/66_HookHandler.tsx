...
export const meta: RecordedMeta = {
  ...
  title: '第三層：條件過了要做什麼',
  script:
    '第三層是動作。時機到了、範圍也符合，它要做什麼？五種。跑一段指令，最常用。呼叫一個 API，把這次的資料送到你指定的網址。呼叫你接上的工具。交給模型判斷一次，適合沒辦法用規則寫死的情況。派一個子代理去查，能做的最多也最慢。有一件事要先知道：不是每個時機都支援五種，寫了不支援的不會報錯，只會安靜地什麼都不做。所以從跑指令開始，它每個時機都支援，你自己在終端機就測得出來。',
  seconds: 45,
};
