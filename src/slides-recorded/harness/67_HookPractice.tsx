...
export const meta: RecordedMeta = {
  ...
  title: '換你掛一條 Hook',
  script:
    '換你掛一條。回到第一題那個例子：金鑰絕對不能寫進程式碼。你不用自己編設定檔，把這句話交給它：每次你要寫檔案之前，先檢查內容裡有沒有 API 金鑰，有就擋下來，掛完故意寫一個假的測一次給我看。三層它會自己填，你要盯的是最後那一步。最常見的失敗不是寫錯，是掛上去之後從來沒被觸發過。驗收兩件事：假金鑰真的被擋下來了嗎，被擋的時候有沒有講清楚哪裡不行。那句理由是寫給它看的，它會拿著理由再試一次。',
  seconds: 45,
};
