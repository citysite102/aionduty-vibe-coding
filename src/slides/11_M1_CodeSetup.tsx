      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-6 max-w-6xl mx-auto items-stretch min-h-[55vh]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 content-center">
          ...
          <AnimatedBlock stepIndex={3} className="flex gap-4 items-start bg-slate-900 border border-slate-800 p-5 rounded-2xl">
            <div className="w-10 h-10 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-bold text-lg shrink-0 mt-1">2</div>
            <div>
              <h3 className="text-xl font-bold text-slate-100 mb-2">試跑一次，確認環境真的通了</h3>
              <p className="text-slate-400 text-sm mb-3">在你想放作品的地方輸入 <code className="text-indigo-300">claude</code>，直接對話。</p>
              <div className="bg-black/50 p-4 rounded-lg border border-slate-800 space-y-3">
                <div className="flex gap-2 text-sm">
                  <span className="text-indigo-400 font-bold shrink-0">You:</span>
                  <span className="text-slate-300">請建立一個 <code className="text-indigo-300">mission-timer</code> 資料夾，裡面放一個計時器的 HTML 網頁。</span>
                </div>
              </div>
        ...
        <AnimatedBlock stepIndex={4} className="bg-gradient-to-b from-sky-900/30 to-indigo-900/20 border border-sky-900/50 rounded-2xl p-5 flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden h-full">
