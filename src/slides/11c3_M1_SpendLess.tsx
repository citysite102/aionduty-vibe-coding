 ...
 *
 * 2026-09-21：這三頁（付費模式、外包比較、怎麼少花一點）從章節五前段搬到最後。
 * 原本收尾那三個浪費是「要動手的三塊」那一頁的鋪陳，但那一頁已經搬到 Slide 52，
 * 排在這之前很多頁，所以這裡不再是它的前導。三個浪費現在是回頭驗收用的：
 * 學員這時候已經把三塊都建過一次，讀起來是「我有沒有踩到」。順序仍然對得上，不要動。
 */
const LEVERS = [
  {
    icon: Activity,
    ...
    cmd: '/usage',
    title: '先知道自己實際花多少',
    body: '打它看本期額度用掉多少、什麼時候重置。沒有這個數字，後面調什麼都是憑感覺。',
    note: null,
  },
  {
    icon: Gauge,
