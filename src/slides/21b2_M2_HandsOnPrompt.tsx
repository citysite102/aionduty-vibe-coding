  ...
  return (
    <SlideLayout title="跟著做：寫出真正能用的 CLAUDE.md" subtitle="Step-by-step Prompt" icon={CheckSquare}>
      <div className="max-w-5xl mx-auto mt-1 space-y-4">
        ...
        <AnimatedBlock stepIndex={2} className={`bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg ${hoverIsolateCard}`}>
        ...
        <AnimatedBlock stepIndex={3} className={`bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg ${hoverIsolateCard}`}>
          <div className="flex items-center gap-3 mb-4">
        ...
        <AnimatedBlock stepIndex={4} className={`bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg ${hoverIsolateCard}`}>
          <div className="flex items-center gap-3 mb-4">
        ...
        <AnimatedBlock stepIndex={5} className={`bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg ${hoverIsolateCard}`}>
          <div className="flex items-center gap-3 mb-4">
